                    ...
                    <div class=" mx-auto pt-3 w-50">
                        <form action="{{ url('/update_product_confirm', $product->id) }}" method="POST"
                            ...
                            <div class="py-2">
                                ...
                                <input class="text-dark" type="number" min="0" max="1" required
                                    name="status" placeholder="product status" value="{{ $product->status }}">
                            </div>
                            <div class="py-2">
                            ...
                            <div class="py-2">
                                ...
                                <select name="category" id="" class="text-dark">
                                    <option class="text-dark" value="{{ $product->category }}" selected>
                            ...
                            <div class="py-2">
                                ...
                                <div class="py-2">
                                    ...
                                    <input class="text-dark" type="number" name="dis_price"
                                        placeholder="product discount" value="{{ $product->discount_price }}">
                                </div>
                                <div>
