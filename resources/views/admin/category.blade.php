          ...
          <div class="content-wrapper">
            ...
            <div>
                ...
                <form action="{{url('/add_category')}}"  method="POST" class="text-center py-3">
                  ...
                  <input class="fs-5 p-2 btn btn-lg btn-warning" type="submit" name="submit" value="Add Category">
            ...
            <table class="mx-auto w-50 border text-center">
              ...
              <tr >
                ...
                <td class="border py-2"><a onclick="return confirm(`Are you sure you want to delete {{$data->category_name}} category?`)" class="btn btn-danger" href="{{url('delete_category',$data->id)}}">Delete</a></td>
              </tr>
              @endforeach
            </table>
            </div>
