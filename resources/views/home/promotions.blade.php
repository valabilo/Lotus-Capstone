    ...
    <main>
        <section>
            <div class="container-md px-5">
                <h2 class="fw-bolder feat-font text-start px-3 pt-5 pb-3"> PROMOTIONS</h2>
            </div>
                            ...
                            <swiper-slide>
                                <div class="img-zoom card h-100 px-2" style="width: 450px;">
                                    ...
                                    <div class="h-100 card-body text-left p-2">
                                        ...
                                        <small
                                            class="card-subtitle text-uppercase fw-bold">{{ $products->code }}</small>
            ...
            <div class="container my-5">
                <img class="mx-auto w-100 px-4" src="{{ asset('public/projectassets/lazada-bg.png') }}"
                    alt="promo.jpg" />
            </div>
        </section>
    </main>
